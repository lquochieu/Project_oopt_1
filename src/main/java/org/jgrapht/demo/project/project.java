...
extends JApplet{public project() throws Exception {
    ...
    private static void showFrame() throws Exception {
        ...
        AllPathButon.addActionListener(new ActionListener() {
